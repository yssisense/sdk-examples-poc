...
import { LineStyleOptions, ValueStyle } from '@sisense/sdk-ui';
import { DataOptions } from '../../config';
...
export const LineDesignPanel = ({
  ...
  const hasY2Axis = useMemo(
    () => dataOptions.values.some((s) => (s as ValueStyle)?.showOnRightAxis),
    [dataOptions]
  );
  return (
    <div className={styles.component}>
      ...
      <LegendSection
        ...
        onClick={(value) => onChange('legend', value)}
      />
      <ValueLabelSection
      ...
      />
      <XAxisSection
        xAxis={styleOptions.xAxis}
        onClick={(value) => onChange('xAxis', value)}
      />
      <YAxisSection
